import { getVehicles, getVehicleById, updateVehicle, deleteVehicle } from "../../../../backend/js/controllers/vehicles_controller.js";
...
class EditarVehiculoC extends HTMLElement {
  ...
  render() {
    this.shadowRoot.innerHTML = `
      ...
      <button id="edit-button">Editar Vehículo</button>
